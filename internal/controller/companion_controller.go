...
// CompanionReconciler reconciles a Companion object
type CompanionReconciler struct {
	client.Client
...
func (r *CompanionReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *CompanionReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&operatorv1alpha1.Companion{}).
		Complete(r)
}
